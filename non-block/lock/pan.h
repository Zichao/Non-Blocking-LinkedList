...
#define PanSource	"lock_linkedList.pml"
...
#define nstates4	7	/* :init: */
#define minseq4	127
#define maxseq4	132
#define endstate4	6

#define nstates3	45	/* delete */
#define minseq3	83
#define maxseq3	126
#define endstate3	44

#define nstates2	47	/* insert */
#define minseq2	37
#define maxseq2	82
#define endstate2	46

#define nstates1	25	/* search */
#define minseq1	13
#define maxseq1	36
#define endstate1	24

#define nstates0	14	/* initlist */
#define minseq0	0
#define maxseq0	12
#define endstate0	13
...
#define Pdelete	((P3 *)this)
typedef struct P3 { /* delete */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, val) - 1*sizeof(int))

#define Pinsert	((P2 *)this)
typedef struct P2 { /* insert */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, ret_right) - 1*sizeof(uchar))

#define Psearch	((P1 *)this)
typedef struct P1 { /* search */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, in_right) - 1*sizeof(uchar))

#define Pinitlist	((P0 *)this)
typedef struct P0 { /* initlist */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, curr) - 1*sizeof(uchar))
